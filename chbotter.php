<?php
// Script Created By Tanzeel khan// to use this script just attach it with the simple bot script and use the iphone on that script it will get tokens from cokis
